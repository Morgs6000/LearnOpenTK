...
public class Program : GameWindow
{
    ...
    protected override void OnRenderFrame(FrameEventArgs args)
    {
        ...
        // limpar todos os buffers relevantes
        ...
        GL.BindTexture(TextureTarget.Texture2D, _textureColorbuffer); // use a textura de anexo de cor como a textura do plano quadrangular
