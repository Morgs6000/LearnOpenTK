...
public class Program : GameWindow
{
    ...
    public Program(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings) : base(gameWindowSettings, nativeWindowSettings)
    {
        ...
        // --------------------------------------------------
        _shader = new Shader("src/stencil_testing.vs", "src/stencil_testing.fs");
        _shaderSingleColor = new Shader("src/stencil_testing.vs", "src/stencil_single_color.fs");
    }
    ...
    protected override void OnRenderFrame(FrameEventArgs args)
    {
        ...
        GL.Clear(ClearBufferMask.ColorBufferBit | ClearBufferMask.DepthBufferBit | ClearBufferMask.StencilBufferBit); // não se esqueça de limpar o stencil buffer!
        ...
        //1º. passe de renderização, desenhe objetos normalmente, gravando no buffer de estêncil
        // --------------------------------------------------
        ...
        model = Matrix4.Identity;
        model *= Matrix4.CreateScale(new Vector3(scale, scale, scale));
        model *= Matrix4.CreateTranslation(new Vector3(-1.0f, 0.0f, -1.0f));
