...
public class Program : GameWindow
{
    ...
    protected override void OnRenderFrame(FrameEventArgs args)
    {
        ...
        transform *= Matrix4.CreateTranslation(new Vector3(0.5f, -0.5f, 0.0f)); // inverti a ordem
        transform *= Matrix4.CreateFromAxisAngle(new Vector3(0.0f, 0.0f, 1.0f), (float)GLFW.GetTime()); // inverti a ordem
