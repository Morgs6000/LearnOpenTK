...
{
    private Atmospheres _atmospher = Atmospheres.DESERT;
    ...
    public Program(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings) : base(gameWindowSettings, nativeWindowSettings)
    {
        ...
        // --------------------------------------------------
        _lightingShader = new Shader("src/multiple_lights.vs", "src/multiple_lights.fs");
    ...
    protected override void OnRenderFrame(FrameEventArgs args)
    {
        ...
        if (_atmospher == Atmospheres.DESERT)
        {
            ...
            // luz pontual 2
            _lightingShader.SetVec3("pointLights[0].position", _pointLightPositions[1]);
            _lightingShader.SetVec3("pointLights[0].ambient", pointLightColors[1] * 0.1f);
            _lightingShader.SetVec3("pointLights[0].diffuse", pointLightColors[1]);
            _lightingShader.SetVec3("pointLights[0].specular", pointLightColors[1]);
            ...
            // luz pontual 3
            _lightingShader.SetVec3("pointLights[0].position", _pointLightPositions[2]);
            _lightingShader.SetVec3("pointLights[0].ambient", pointLightColors[2] * 0.1f);
            _lightingShader.SetVec3("pointLights[0].diffuse", pointLightColors[2]);
            _lightingShader.SetVec3("pointLights[0].specular", pointLightColors[2]);
            ...
            // luz pontual 4
            _lightingShader.SetVec3("pointLights[0].position", _pointLightPositions[3]);
            _lightingShader.SetVec3("pointLights[0].ambient", pointLightColors[3] * 0.1f);
            _lightingShader.SetVec3("pointLights[0].diffuse", pointLightColors[3]);
            _lightingShader.SetVec3("pointLights[0].specular", pointLightColors[3]);
        ...
        if (_atmospher == Atmospheres.HORROR)
        {
            ...
            _lightingShader.SetVec3("pointLights[0].specular", pointLightColors[2]);
            _lightingShader.SetFloat("pointLights[2].constant", 1.0f);
            _lightingShader.SetFloat("pointLights[0].linear", 0.22f);
            _lightingShader.SetFloat("pointLights[0].quadratic", 0.20f);
        ...
        // também desenhe o(s) objeto(s) de luminárialuz do tipo "spot"; não renderize o objeto de luz 
