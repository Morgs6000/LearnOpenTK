...
public class Window : GameWindow
{
    ...
    protected override void OnUpdateFrame(FrameEventArgs args)
    {
        ...
        camera.ProcessMouseScroll(MouseState.ScrollDelta.Y);
    }
    ...
    protected override void OnRenderFrame(FrameEventArgs args)
    {
        ...
        projection *= Matrix4.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(camera.Zoom), (float)Screen.widht / (float)Screen.height, 0.1f, 100.0f);
